// Copyright (c) 2012STS Software, All rights reserved
using System;
    ...
    public class Settings
    {
        ...
        private static RegExClassification[] DefaultPatterns()
        {
            return new[]
            {
                ...
                new RegExClassification {RegExPattern = @"0 failed|Succeeded|(Found \d+ duplicate lines)", ClassificationType = ClassificationTypes.BuildHead, IgnoreCase = true},
                new RegExClassification {RegExPattern = @"(\W|^)(error|fail|failed|exception|(Duplicate found between lines))\W", ClassificationType = ClassificationTypes.LogError, IgnoreCase = true},
